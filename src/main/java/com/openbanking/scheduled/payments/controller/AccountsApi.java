package com.openbanking.scheduled.payments.controller;

import com.openbanking.scheduled.payments.model.OBReadScheduledPayment3;
...
public interface AccountsApi {
	...
	@Operation(summary = "Get Scheduled Payments", operationId = "getAccountsAccountIdScheduledPayments", description = "", tags = { "Scheduled Payments", })
	...
	default ResponseEntity<OBReadScheduledPayment3> getAccountsAccountIdScheduledPayments(@Parameter(name = "AccountId", required = true)
