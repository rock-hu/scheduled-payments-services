...
@Tag(name = "scheduled-payments", description = "scheduled-payments")
@RequestMapping(value = "")
public interface ScheduledPaymentsApi {

	@Operation(summary = "Get Scheduled Payments", operationId = "getScheduledPayments", description = "", tags = { "Scheduled Payments", })
