package com.openbanking.scheduled.payments.configuration;
...
public class SwaggerDocumentationConfig {
	...
	Artifact artifact) {
		return GroupedOpenApi.builder().group("scheduled-payments-services")
				...
				.packagesToScan("com.openbanking.scheduled.payments.controller").build();
	}
